...
public:
    ...
    : it_(nh_)
  {
    ...
    image_sub_ = it_.subscribe("/image_input", 1, &ImageConverter_Bin::imageCb, this);
...
{
  ros::init(argc, argv, "image_converter_bin");
  ImageConverter_Bin ic;
  ros::spin();
  return 0;
}
